<template>
  <div class="image_viewer">
    <transition name="slide-fade">
      <div v-show="selectedImageIndex > -1" class="container" @click="handleContainerClick">
        <div class="header">
    ...
    export default {
        ...
        methods: {
            ...
            handleContainerClick(event) {
                // Check if the click is directly on the container (not on carousel or its children)
                if (event.target.className === "VueCarousel carousel-container") {
                    this.goBack()
                }
            }
        },
